...
- **Выход:** PNG-изображение с увеличенной границей (8 клеток по 60px + границы по 45px = ~570x570 px)
- **Индикатор хода:** В правом нижнем углу отображается треугольник вершиной вверх, указывающий чей ход. Белый ход — белый треугольник с чёрной границей, чёрный ход — чёрный треугольник.
...
7. При первом запуске Google запросит разрешения (необходим доступ к текущему документу) — предоставьте их
